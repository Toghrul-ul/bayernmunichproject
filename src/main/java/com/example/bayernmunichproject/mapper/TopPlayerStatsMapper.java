...
//    TopPlayerStatsDto toDto(TopPlayerStatsEntity entity);
//
//    TopPlayerStatsEntity toEntity(TopPlayerStatsDto dto);
//
//    void mapForUpdate(@MappingTarget TopPlayerStatsEntity entity, TopPlayerStatsDto dto);
//}
