...
//    LeagueStandingDto toDto(LeagueStandingEntity entity);
//
//    LeagueStandingEntity toEntity(LeagueStandingDto dto);
//
//    void mapForUpdate(@MappingTarget LeagueStandingEntity entity, LeagueStandingDto dto);
//}
